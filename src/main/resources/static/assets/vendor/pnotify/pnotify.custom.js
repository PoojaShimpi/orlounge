...
(function ($) {
    ...
    $.extend(PNotify.styling.bootstrap2, {closer: "icon-remove", pin_up: "icon-pause", pin_down: "icon-play"});
    $.extend(PNotify.styling.bootstrap3, {
        closer: "glyphicon glyphicon-remove",
        pin_up: "glyphicon glyphicon-pause",
        pin_down: "glyphicon glyphicon-play"
    });
    $.extend(PNotify.styling.fontawesome, {closer: "fa fa-times", pin_up: "fa fa-pause", pin_down: "fa fa-play"});
})(jQuery);
(function ($) {
    var _init = PNotify.prototype.init, _open = PNotify.prototype.open, _remove = PNotify.prototype.remove;
...
(function ($) {
    PNotify.prototype.options.confirm = {
        ...
        align: "right",
        buttons: [{
            text: "Ok", addClass: "", click: function (notice) {
    ...
    $.extend(PNotify.styling.bootstrap2, {btn: "btn"});
    $.extend(PNotify.styling.bootstrap3, {btn: "btn btn-default"});
    $.extend(PNotify.styling.fontawesome, {btn: "btn btn-default"});
})(jQuery);
(function ($) {
    var permission;
    ...
    PNotify.prototype.options.desktop = {desktop: false, icon: null};
    PNotify.prototype.modules.desktop = {
        init: function (notice, options) {
            ...
            notice.desktop = notify(notice.options.title, {icon: options.icon, body: notice.options.text});
...
(function ($) {
    ...
    PNotify.prototype.modules.history = {
        inHistory: false, init: function (notice, options) {
    ...
    $.extend(PNotify.styling.bootstrap2, {hi_menu: "well", hi_btn: "btn", hi_btnhov: "", hi_hnd: "icon-chevron-down"});
    $.extend(PNotify.styling.bootstrap3, {
        hi_menu: "well",
...
(function ($) {
    ...
    PNotify.prototype.options.nonblock = {nonblock: false, nonblock_opacity: .2};
...
(function ($) {
    PNotify.prototype.options.reference = {putThing: false, labels: {text: "Spin Around"}};
    ...
    $.extend(PNotify.styling.jqueryui, {athing: "ui-icon ui-icon-refresh"});
    $.extend(PNotify.styling.bootstrap2, {athing: "icon-refresh"});
    $.extend(PNotify.styling.bootstrap3, {athing: "glyphicon glyphicon-refresh"});
    $.extend(PNotify.styling.fontawesome, {athing: "fa fa-refresh"});
})(jQuery);