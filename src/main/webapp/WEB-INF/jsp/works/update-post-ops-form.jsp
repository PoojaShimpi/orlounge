...
<div class="form-group">
    ...
    <div class="col-md-6">
        <input   required id="title" name="surgeon" class="form-control " value="<%=surgeon%>" />
...
<div class="form-group">
    ...
    <div class="col-md-6"><textarea  id="operation" name="operation" class="form-control" ><%=operation%></textarea></div>
...
<div class="form-group">
    ...
    <div class="col-md-6"><textarea id="activity" name="activity" class="form-control" ><%=activity%></textarea></div>
</div>


<div class="form-group">
    <label class="col-md-3 control-label">Contact number in case of an emergency</label>
    <div class="col-md-6"><input   id="emergencyContact" name="emergencyContact" value="<%=emCnt%>" class="form-control"/></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6"><textarea   id="restriction" name="restriction" class="form-control" ><%=restrict%></textarea></div>
</div>

<div class="form-group">
    <label class="col-md-3 control-label">Wound care</label>
    <div class="col-md-6"><textarea  id="woundCare" name="woundCare" class="form-control" ><%=woundCare%></textarea></div>
</div>

<div class="form-group">
    <label class="col-md-3 control-label">Medications</label>
    <div class="col-md-6"><textarea  id="medications" name="medications" class="form-control" ><%=med%></textarea></div>
</div>

<div class="form-group">
    <label class="col-md-3 control-label">Supplies and equipment</label>
    <div class="col-md-6"><textarea id="supplies" name="supplies" class="form-control" ><%=supp%></textarea></div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6 form-inline" >
        <span class="input-group-addon">
            <input type="hidden"   id="officeVisit" name="officeVisit" value="<%=ofcVisit%>" class="form-control"/>
...
<div class="form-group">
    ...
    <div class="col-md-6"><textarea   id="instructions" name="instructions" class="form-control" ><%=ins%></textarea></div>
</div>


<div class="form-group">
    <label class="col-md-3 control-label">Others</label>
    <div class="col-md-6"><textarea id="other" name="other" class="form-control" ><%=oth%></textarea></div>
</div>
