...
<div class="form-group">
    ...
    <input required  id="procedure" name="procedure" class="col-md-6 " onchange="$('#addToTable').prop('disabled', false);" />
</div>

<div class="form-group">
    <label class="col-md-3  control-label">Speciality</label>
    <input  id="speciality" name="speciality" class="col-md-6 "  />
</div>

<div class="form-group">
    <label class="col-md-3  control-label">Special Considerations</label>
    <textarea  id="spConsideration" name="spConsideration" class="col-md-6 "  ></textarea>
</div>

<div class="form-group">
    <label class="col-md-3  control-label">Anaesthesia  Considerations</label>
    <textarea  id="anConsideration" name="anConsideration" class="col-md-6 "  ></textarea>
</div>
<div class="form-group">
    <label class="col-md-3  control-label">Room Setup</label>
    <textarea id="roomSetup" name="roomSetup" class="col-md-6 "  ></textarea>
</div>
<div class="form-group">
    <label class="col-md-3  control-label">Preparation and Drape</label>
    <textarea   id="prepDrape" name="prepDrape" class="col-md-6 "  ></textarea>
</div>
<div class="form-group">
    <label class="col-md-3  control-label">Equipment</label>
    <textarea    id="equipment" name="equipment" class="col-md-6 "  ></textarea>
</div>
<div class="form-group">
    <label class="col-md-3  control-label">Dressings and Drains</label>
    <textarea  id="dressingDrain" name="dressingDrain" class="col-md-6 "  ></textarea>
</div>
<div class="form-group">
    <label class="col-md-3  control-label">Others</label>
    <textarea   id="others" name="others" class="col-md-6 "  ></textarea>
</div>
 <div class="form-group">
...
<!-- <div class="form-group" style="margin: 0;">
    <button id="btn-save" name="btn-save" class="btn btn-primary " onclick="dataSubmit()">Savetest</button>
