...
<%
    ...
    String desc = inServiceBean.getText() == null ? "" : inServiceBean.getText();
%>
...
<div class="form-group">
    ...
    <div class="col-md-6">
        ...
        <input type="hidden"  id="id" name="id" value="<%=inServiceBean.getId() != null ? inServiceBean.getId() : ""%>" class="col-md-4"/>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6">
        <input type="date"  required id="date" name="date" value="<%=date%>" class="form-control"/>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-6">
        <input  required id="presenter" name="presenter" value="<%=presenter%>" class="form-control"/>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-md-10">
        ...
        <div class="">
            <div  id="descriptionB" class="summernote" data-plugin-summernote  data-plugin-options='{ "height": 180, "codemirror": { "theme": "ambiance"} }'><%=desc%></div>
        </div>
    </div>
</div>
