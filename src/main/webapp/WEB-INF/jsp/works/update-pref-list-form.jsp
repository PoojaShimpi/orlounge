...
<div class="form-group">
    ...
    <input id="speciality" name="speciality" class="col-md-6 " value="<%=sp%>" />
...
<div class="form-group">
    ...
    <input required  id="procedure" name="procedure" class="col-md-6 " value="<%=procedure%>" onchange="$('#addToTable').prop('disabled', false);" />
</div>


<div class="form-group">
    <label class="col-md-3  control-label">Special Considerations</label>
    <textarea id="spConsideration" name="spConsideration" class="col-md-6 "  ><%=spCons == null ? "" : spCons%></textarea>
...
<div class="form-group">
    ...
    <textarea id="anConsideration" name="anConsideration" class="col-md-6 "  ><%=anCons == null ? "" : anCons%></textarea>
...
<div class="form-group">
    ...
    <textarea  id="roomSetup" name="roomSetup" class="col-md-6 "  ><%=roomSetup == null ? "" : roomSetup%></textarea>
</div>


<div class="form-group">
    <label class="col-md-3  control-label">Preparation and Drape</label>
    <textarea id="prepDrape" name="prepDrape" class="col-md-6 "  ><%=prepDrape == null ? "" : prepDrape%></textarea>
...
<div class="form-group">
    ...
    <textarea   id="equipment" name="equipment" class="col-md-6 "  ><%=eq == null ? "" : eq%></textarea>
</div>
...
<div class="form-group">
    ...
    <textarea    id="dressingDrain" name="dressingDrain" class="col-md-6 "  ><%=dressDrain == null ? "" : dressDrain%></textarea>
</div>


<div class="form-group">
    <label class="col-md-3  control-label">Others</label>
    <textarea   id="others" name="others" class="col-md-6 "  ><%=others == null ? "" : others%></textarea>
...
<div class="form-group">
    <form enctype="multipart/form-data" id="ins-form" action="saveinstrument.html?id=<%=bean.getId()%>&action=<%=action%>" method="POST">
            ...
            <div id="collapseTwo" class="panel-collapse collapse in">
                <div class="panel-body">
                    ...
                    <div class="row" style="float: right;">
                        <div class="col-sm-0">
                            <div class="mb-md">
                                <button id="addToTable" name="addToTable" class="btn btn-primary"><i>Add Preference</i></button>
                                <%--  <button  type="button" id="uploadInstrument"  onchange="savePreList()" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                                      Browse and upload
                                  </button>
                                  <button  type="button" id="downloadSampleCSV"  onclick="downloadSample()" class="btn btn-primary" >Download Template CSV</button>--%>
...
<div id="push"></div>
 ...
 <div class="form-group">
    <button id="btn-save" name="btn-save" class="btn btn-primary " onclick="dataSubmit()">Save</button>
</div> 
<!-- <div class="panel-footer clearfix">
    <a class="btn btn-primary pull-right" href="#save" onclick="dataSubmit()" >Save Preference List</a>
</div> -->
